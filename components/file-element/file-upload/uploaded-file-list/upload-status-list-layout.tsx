  ...
  return (
    <div>
      {files && files.length > 0 && !close && (
        <div className="w-screen h-screen bg-black bg-opacity-70 flex justify-center items-center absolute top-0 left-0 right-0 bottom-0 sm:overflow-hidden sm:flex-none sm:items-stretch">
          {children}
        </div>
      )}
    </div>
